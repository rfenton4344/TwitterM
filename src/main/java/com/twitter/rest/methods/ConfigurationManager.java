...
public class ConfigurationManager implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent d)
    {
        ...
        try
        {
            BufferedWriter consumerKeyWriter = new BufferedWriter(new FileWriter(System.getenv("ROOT")+"consumerKey"));
        ...
        try
        {
            BufferedWriter consumerSecretWriter = new BufferedWriter(new FileWriter(System.getenv("ROOT")+"consumerSecret"));
        ...
        try
        {
            BufferedWriter accessTokenWriter = new BufferedWriter(new FileWriter(System.getenv("ROOT")+"accessToken"));
        ...
        try
        {
            BufferedWriter accessTokenSecretWriter = new BufferedWriter(new FileWriter(System.getenv("ROOT")+"accessTokenSecret"));
